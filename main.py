...
if __name__ == '__main__':
    ...
    while True:
        ...
        frameCut = frame[cropY:cropY+min_size, cropX:cropX+min_size]
        ...
        for i in range(len(scores)):
            if ((scores[i] > 0.65) and (scores[i] <= 1.0)):
                ...
                if xmax <= center_min_size and ymax <= center_min_size:
                    if is_path_1:
                        continue
                    is_path_1 = True
                    is_where = 1
                    #rf24.write(b'11')
                elif xmin > center_min_size and ymax <= center_min_size:
                    if is_path_2:
                        continue
                    is_path_2 = True
                    is_where = 2
                    #rf24.write(b'21')
                elif xmin > center_min_size and ymin > center_min_size:
                    if is_path_3:
                        continue
                    is_path_3 = True
                    is_where = 3
                    #rf24.write(b'31')
                elif xmax <= center_min_size and ymin > center_min_size:
                    if is_path_4:
                        continue
                    is_path_4 = True
                    is_where = 4
